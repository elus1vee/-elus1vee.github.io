...
function openRulesPage() {
  ...
  p3.innerHTML =
    "<span style=color:green>Лёгкий</span> уровень сложности включает три режима: <span style=text-decoration:underline>классический</span> (попадаются любые математические операции и времени сколько угодно), <span style=text-decoration:underline>на время</span> (за 60с решить наибольшее число задач).";
  div.append(p3);
